...
class sl_modules extends CModule
{
    /**
     * ID модуля
     * @var string
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage('SL_MODULES_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('SL_MODULES_MODULE_DESCRIPTION');
    }
    ...
    public function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(GetMessage("SL_MODULES_MODULE_DESCRIPTION"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/rest/install/step1.php");
        return true;
